		...
		<nav class="w3-sidebar w3-black w3-collapse w3-top w3-large w3-padding" style="width:250px;font-weight:bold;">
			...
			<div class="w3-bar-block">
				<div>
					<ul>
						<c:if test="${ id == null }">
							<li><a href="/expro/LoginForm.do" class="w3-bar-item w3-button w3-hover-white">로그인</a></li>
							<li><a href="/expro/MemberJoinForm.do" class="w3-bar-item w3-button w3-hover-white">회원가입</a></li>
						</c:if>
						<c:if test="${ id != null }">
							<li><a href="/expro/MemberUpdateForm.do" class="w3-bar-item w3-button w3-hover-white">${ nickname }(${ id })</a></li>
							<li><a href="/expro/LogOut.do" class="w3-bar-item w3-button w3-hover-white">로그아웃</a></li>
						</c:if>
